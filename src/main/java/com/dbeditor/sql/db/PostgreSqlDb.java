...
public class PostgreSqlDb extends SqlDb {
    ...
    // public PostgreSqlDb(String dbHost, String dbUser, String dbPassword, String dbPort) {
    //     this.dbHost = dbHost;
    //     this.dbUser = dbUser;
    ...
    //                 Entity table = buildTable(meta, catalog, tableSchema, tableName);
    ...
    //  */
    // private Entity buildTable(DatabaseMetaData meta, String catalog, String schemaPattern, String tableName) throws SQLException {
