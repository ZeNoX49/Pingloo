...
public class MsSqlDb extends SqlDb {
    ...
    // public MsSqlDb(String dbHost, String dbUser, String dbPassword, String dbPort) {
    //     this.dbHost = dbHost;
    //     this.dbUser = dbUser;
    ...
    public void loadDb(String dbName) {
        ...
        //             Entity table = buildTable(meta, catalog, tableName);
    ...
    //  */
    // private Entity buildTable(DatabaseMetaData meta, String catalog, String tableName) throws SQLException {
