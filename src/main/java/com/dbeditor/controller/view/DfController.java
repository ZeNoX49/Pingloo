...
public class DfController extends TextView {
    ...
    @Override
    public void open() {
        // List<Entity> tablesSorted = DbManager.sortTables(MainApp.schema.getTables());
    ...
    private void doTextNormal(List<Entity> tablesSorted) {
        // StringBuilder text = new StringBuilder();

        // for (Entity t : tablesSorted) {
    ...
    private void doTextExport(List<Entity> tablesSorted) {
        // StringBuilder text = new StringBuilder();
